...
public class ConsumerGenericFilter extends Filter {
    ...
    public SofaResponse invoke(FilterInvoker invoker, SofaRequest request) throws SofaRpcException {
        try {
            ...
            // 修正超时时间
            int clientTimeoutFromGenericContext = getClientTimeoutFromGenericContext(request.getMethodName(),
                request.getMethodArgs());
            if (clientTimeoutFromGenericContext > 0) {
                request.setTimeout(clientTimeoutFromGenericContext);
            }
